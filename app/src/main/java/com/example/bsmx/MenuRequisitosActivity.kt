...
class MenuRequisitosActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.menu_requisitos)

        imageView = findViewById(R.id.imageView11)


        val btnTakePhoto: Button = findViewById(R.id.btnFoto)
        ...
        val btnSelectImage: Button = findViewById(R.id.btnBuscar)
        ...
        val arrayAdapter =
            ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, requisitos)
        ...
        spnDocumento.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                Toast.makeText(
                    applicationContext,
                    "Requisito seleccionado: " + requisitos[position],
                    Toast.LENGTH_SHORT
                ).show()
            }
